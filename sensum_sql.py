...
def milho_filter_sql():
    ...
    value = os.environ.get(
        ...
        RTRIM(UPPER(PRODUTO)) IN (
            'MIST PAO DA FAZENDA COM ETIQUETA VIAPANE 10KG',
            'MIST PAO DA FAZENDA COM ETIQUETA VIAPANE 20KG CAIXA',
            'MIST PAO DA FAZENDA VIAPANE 10KG',
            'MIST PAO DA FAZENDA 20KG CAIXA'
        )
